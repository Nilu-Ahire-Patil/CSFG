...
ALTER TABLE [dbo].[tbl_note]  WITH CHECK ADD  CONSTRAINT [FK_note_img] FOREIGN KEY([note_type]) REFERENCES [dbo].[tbl_img] ([img_id])
ALTER TABLE [dbo].[tbl_note] CHECK CONSTRAINT [FK_note_img]
...
INSERT INTO [dbo].[tbl_img]([img_name])VALUES('dept.jpg');
...
INSERT INTO [dbo].[tbl_sub]([sub_code],[sub_name],[sub_teacher],[sub_year],[sub_sem])
     VALUES('LLAP','LOW LEVEL ASSEMBLY PROGRAMMING','NPP',2023,1);
INSERT INTO [dbo].[tbl_sub]([sub_code],[sub_name],[sub_teacher],[sub_year],[sub_sem])
...
INSERT INTO [dbo].[tbl_note]([note_sub],[note_upl_by],[note_link],[note_date],[note_type],[isValid])
     VALUES(1,22111065,'temp_kink',CONVERT(datetime,'2023-12-30 00:00:00.000'),4,1)
INSERT INTO [dbo].[tbl_note]([note_sub],[note_upl_by],[note_link],[note_date],[note_type],[isValid])
     VALUES(2,22111027,'temp_link2',CONVERT(datetime,'2023-12-29 00:00:00.000'),5,1)
INSERT INTO [dbo].[tbl_note]([note_sub],[note_upl_by],[note_link],[note_date],[note_type],[isValid])
     VALUES(3,22111065,'temp_kink',CONVERT(datetime,'2023-12-18 00:00:00.000'),4,0)
INSERT INTO [dbo].[tbl_note]([note_sub],[note_upl_by],[note_link],[note_date],[note_type],[isValid])
     VALUES(4,22111027,'temp_link2',CONVERT(datetime,'2023-12-17 00:00:00.000'),5,0)
...
INSERT INTO [dbo].[tbl_eve]([eve_img],[eve_name],[eve_link],[eve_date],[eve_disc])
     VALUES(8,'Alumini Meet','upcomming link',CONVERT(date,'2024-01-16'),'this is upcomming discrepction')
...
INSERT INTO [dbo].[tbl_gal]([gal_img],[gal_eve])
     VALUES(10,3)
INSERT INTO [dbo].[tbl_gal]([gal_img],[gal_eve],[isValid])
     VALUES(1,1,1)
INSERT INTO [dbo].[tbl_gal]([gal_img],[gal_eve],[isValid])
     VALUES(2,2,1)
